...
void Player::UpdateMoveInput(void)
{
	...
	{
		// ÉtÉåÅ[ÉÄéûä‘Ç…àÀë∂Ç≥ÇπÇƒ MOVE_SPEED Çé¿ç€ÇÃë¨ìxÇ…égÇ§
...
bool Player::IsRunInput(void) const
{
	...
	if (IsKeyboardInputEnabled())
	{
		// ì¸óÕê›íËÇÃ runKey ÇÉ`ÉFÉbÉN + ç∂âESHIFT ÇÃóºï˚ÇãñóeÇ∑ÇÈ
...
// QQQQQQQQQQQQQQQ: „Ç´„É°„É©„ÅÆÂâçÊñπÂêë„Éô„ÇØ„Éà„É´„ÇíË®àÁÆó„Åô„ÇãÈñ¢Êï∞„ÇíËøΩÂä†„Åó„Å¶„Åè„Å†„Åï„ÅÑÔºà„Ç´„É°„É©„ÅÆÂêë„Åç„Åã„ÇâÂâçÊñπÂêë„ÇíÊ±Ç„ÇÅ„ÇãÔºâ„ÄÇ
